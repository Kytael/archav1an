...
PRESETS = {
    ...
    "anime-crf18": {
        ...
        "autocrop": False,
        "aggressive": False,
        "fast_params": "--lp 3 --tune 0 --hbd-mds 0 --keyint 305 --filtering-noise-detection 1",
        "final_params": "--lp 3 --tune 0 --hbd-mds 1 --keyint 305 --filtering-noise-detection 1",
    },
    "anime-crf25": {
        "quality": 25,
        "photon_noise": 2,
        ...
        "autocrop": False,
        "aggressive": False,
        "fast_params": "--lp 3 --tune 0 --hbd-mds 0 --keyint 305 --filtering-noise-detection 4",
        "final_params": "--lp 3 --tune 0 --hbd-mds 1 --keyint 305 --filtering-noise-detection 4",
    },
    "anime-crf32": {
        "quality": 32,
        "photon_noise": 2,
...
def main():
    ...
    if args.denoise_scunet:
        ...
        preset["denoise_model"] = args.denoise_model
